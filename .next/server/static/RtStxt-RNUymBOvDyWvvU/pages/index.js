...
var vins_getRandomVin = function getRandomVin() {
  var vinsArray = keys_default()(vins);

  return vinsArray[Math.floor(Math.random() * vinsArray.length)];
};
// CONCATENATED MODULE: ./components/NotificationBar.jsx
...
var NotificationBar_NotificationBar =
/*#__PURE__*/
function (_React$Component) {
  ...
  function NotificationBar() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf_getPrototypeOf(NotificationBar)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(NotificationBar, [{
    ...
    value: function render() {
      ...
      }, "Success!"), external_react_default.a.createElement("p", null, "Vin was copied!"));
    }
  }]);
...
var pages_getVehicleByVin = function getVehicleByVin(vin) {
  return external_axios_default.a.get("https://vpic.nhtsa.dot.gov/api/vehicles/DecodeVinExtended/".concat(vin, "?format=json")).then(function (resp) {
...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      vins: _defineProperty({}, vins_getRandomVin(), null)
    });
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      pages_getVehicleByVin(vin).then(function (vehicleInfo) {
        _this2.setState({
    ...
    value: function onSubmit(e) {
      ...
      e.preventDefault();
      var vin = vins_getRandomVin();
      pages_getVehicleByVin(vin).then(function (vehicleInfo) {
        _this3.setState({
          vins: _objectSpread(_defineProperty({}, vin, vehicleInfo), _this3.state.vins)
        });
      }).then(function () {
        return external_copy_to_clipboard_default()(vin);
      });
    }
  }, {
    key: "copyVin",
    value: function copyVin() {
      external_copy_to_clipboard_default()(this.getVins()[0]);
    }
  }, {
    key: "getVins",
    value: function getVins() {
      return keys_default()(this.state.vins);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, "VIN")), external_react_default.a.createElement("p", null, "Making it easy to generate and copy ", external_react_default.a.createElement("abbr", {
        title: "Vehicle Identification Numbers"
      }, "VINs")), external_react_default.a.createElement("form", {
        onSubmit: this.onSubmit
      }, external_react_default.a.createElement("h2", {
        "aria-live": "polite"
      }, "Result: ", external_react_default.a.createElement("em", null, this.getVins()[0])), external_react_default.a.createElement("button", {
        type: "button",
        onClick: this.copyVin
      }, "Copy to Clipboard"), external_react_default.a.createElement("button", {
        type: "submit"
      }, "Get and Copy new VIN"), external_react_default.a.createElement("h3", null, "Vehicle Info"), external_react_default.a.createElement("pre", null, external_react_default.a.createElement("code", null, function (vehicleInfo) {
        return vehicleInfo ? stringify_default()(vehicleInfo, null, 4) : 'Loading...';
      }(this.state.vins[this.getVins()[0]])))), this.getVins().length > 1 ? external_react_default.a.createElement("section", null, external_react_default.a.createElement("h2", null, "History"), external_react_default.a.createElement("dl", null, this.getVins().slice(1).map(function (v) {
        return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("dt", {
          key: "".concat(v, "-term")
        }, v), external_react_default.a.createElement("dd", {
          key: "".concat(v, "-definition")
        }, external_react_default.a.createElement("pre", null, external_react_default.a.createElement("code", null, stringify_default()(_this4.state.vins[v], null, 4)))));
      }))) : null);
    }
  }]);
