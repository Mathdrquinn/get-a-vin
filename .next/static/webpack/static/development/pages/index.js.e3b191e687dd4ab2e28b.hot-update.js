...
var Index = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Index, [{
    ...
    value: function componentDidMount() {
      var vin = getRandomVin().then(function (data) {
        console.log(data);
        var foo = data;
        debugger;
      }); // getVehicleByVin(vin)
    ...
    value: function onSubmit(e) {
      e.preventDefault();
      var vin = getRandomVin().then(function (d) {
        debugger;
      }); // getVehicleByVin(vin)
      //     .then(vehicleInfo => {
    ...
    value: function render() {
      ...
      return __jsx("main", {
        ...
        }, __jsx("pre", null, __jsx("code", null, JSON.stringify(_this2.state.vins[v], null, 4)))));
      }))) : null);
    }
  }]);
...
//# sourceMappingURL=index.js.e3b191e687dd4ab2e28b.hot-update.js.map